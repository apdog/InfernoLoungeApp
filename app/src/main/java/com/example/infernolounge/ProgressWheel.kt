package com.example.infernolounge
...
class ProgressWheel : View {
    ...
    private var mCountText: String? = "10" // TODO: use a default from R.string...
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (mCountText != null){
            ...
            canvas.drawText(mCountText!!,
                ...
                (this.height / 2).toFloat() + if (mDefText == null) mCountTextSize/3 else 0f,
                mCountTextPaint
            )
        }
